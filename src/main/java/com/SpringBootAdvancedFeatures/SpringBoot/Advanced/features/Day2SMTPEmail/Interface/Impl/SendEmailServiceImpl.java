package com.SpringBootAdvancedFeatures.SpringBoot.Advanced.features.Day2SMTPEmail.Interface.Impl;
...
public class SendEmailServiceImpl implements SendEmailService {
    ...
    public String sendSimpleMail(EmailSender details)
    {
    ...
    public String
    sendMailWithAttachment(EmailSender details)
    {
